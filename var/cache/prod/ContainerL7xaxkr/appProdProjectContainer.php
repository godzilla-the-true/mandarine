...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CiU4NgMBDh', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('IeosfsPGE76HNxobWMQuCCxDAdOmME3Yo5Z99a07yQwTGp3wK9Gh7CyFb0ac4ZOk'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('IeosfsPGE76HNxobWMQuCCxDAdOmME3Yo5Z99a07yQwTGp3wK9Gh7CyFb0ac4ZOk');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                53 => ($this->targetDirs[3].'/modules/trustpilot/translations'),
                54 => ($this->targetDirs[3].'/modules/ps_specials/translations'),
                55 => ($this->targetDirs[3].'/modules/ps_newproducts/translations'),
                56 => ($this->targetDirs[3].'/modules/ps_accounts/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'IeosfsPGE76HNxobWMQuCCxDAdOmME3Yo5Z99a07yQwTGp3wK9Gh7CyFb0ac4ZOk',
