...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/chezak.net/mandarine.chezak.net/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/var/www/vhosts/chezak.net/mandarine.chezak.net/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/chezak.net/mandarine.chezak.net/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/var/www/vhosts/chezak.net/mandarine.chezak.net/var/cache/prod//doctrine/orm/Proxies');
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(false);
        $a->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $a->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('psmd_'))) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_fac6aefc5e74b27ae99958b1b98da35e7d7278ec04df828f32a4e7976aa58289');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/vhosts/chezak.net/mandarine.chezak.net/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/vhosts/chezak.net/mandarine.chezak.net/var/cache/prod//localization'))) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('psmd_');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/var/www/vhosts/chezak.net/mandarine.chezak.net/app',
            'kernel.project_dir' => '/var/www/vhosts/chezak.net/mandarine.chezak.net',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/var/www/vhosts/chezak.net/mandarine.chezak.net/var/cache/prod/',
            ...
            'ps_cache_dir' => '/var/www/vhosts/chezak.net/mandarine.chezak.net/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/vhosts/chezak.net/mandarine.chezak.net/var/cache/prod//doctrine/orm/Proxies',
